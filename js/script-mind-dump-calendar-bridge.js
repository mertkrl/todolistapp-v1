...
//  - addGlobalTask/hasTimeConflict/showPremiumModal: script.js'ten ES
//    module import'uyla kullanılıyor (showPremiumModal hoisting'e dayanıyordu,
//    düzeltildi).

import { addGlobalTask, hasTimeConflict, setMindDumpsRef, showPremiumModal } from './script.js';
import { timeToMins } from './script-date-time-utils.js';
