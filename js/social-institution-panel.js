...
import {
    ...
    renderInstitutionalOverviewIntro,
       ...
       // Öğretmenin Genel Bakış'ta gördüğü kısayol widget'ı social-institution-panel-shortcuts-widget.js'e
       // çıkarıldı (kendi içinde tamamen izole, sadece _gotoClassroomSubtab'a dışarıdan bağımlı).
       export { _renderClassroomShortcutsWidget } from './social-institution-panel-shortcuts-widget.js';
