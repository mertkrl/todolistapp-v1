...
def main():
    files = sys.argv[1:] or [
        ...
        'script-date-time-utils.js', 'script-calendar-date-utils.js', 'planning-utils.js', 'planning-quick-create.js', 'planning-collab-wait.js', 'planning-lesson-plan-invites.js', 'planning-dependency-graph.js',
    ]
    base = Path.cwd()
    total = 0
    for f in files:
