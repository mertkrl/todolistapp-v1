...
def main():
    files = sys.argv[1:] or [
        ...
        'social-message-pins.js', 'social-group-focus-break-chat.js', 'social-group-focus-leave.js', 'social-group-focus-task-selector.js', 'social-chat-list-actions.js', 'social-block-users.js', 'social-chat-local-delete.js',
    ]
    base = Path.cwd()
    total = 0
    for f in files:
