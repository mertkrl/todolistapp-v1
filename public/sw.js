const CACHE = 'focusai-f6c7abf1ae';
const FILES = [
  './',
  './index.html',
  './a11y-focus-visible.css',
  './a11y-reduced-motion.css',
  './add-friend-modal.css',
  './app-login-gate.css',
  './app-login-gate.js',
  ...
  './planning-lesson-plan-assign-status-html.js',
  ...
  './planning-milestone-wizard-task-render.js',
  ...
  './script-calendar-month-view-event-html.js',
  ...
  './script-goal-modal-analysis.js',
  './script-goal-modal-cards.js',
  './script-goal-modal-list-utils.js',
  ...
  './script-journal-library-book-detail.js',
  './script-journal-library-deepwrite.js',
  './script-journal-library-month-modal.js',
  ...
  './script-mind-dump-tag-meta.js',
  './script-mind-dump-time-utils.js',
  './script-mind-dump.js',
  './script-misc-widgets.js',
  './script-move-task-to-date.js',
  './script-nlp.js',
  './script-onboarding-tour-flows.js',
  './script-onboarding-tour-progress-storage.js',
  ...
  './script-timer-alarm-sound.js',
  './script-timer-flame.js',
  './script-timer-mode-color.js',
  './script-timer.js',
  ...
  './social-buddy-habits-notifications.js',
  './social-buddy-habits-pure-utils.js',
  ...
  './social-dc-room-lifecycle-teardown.js',
  ...
  './social-dm-notifications-context-menu.js',
  './social-dm-notifications-toasts.js',
  ...
  './social-institution-classroom-sections-report.js',
  ...
  './social-institution-my-groups-institution-modal.js',
  './social-institution-my-groups-invite-modal.js',
  './social-institution-my-groups.js',
  './social-institution-panel-shortcuts-widget.js',
  ...
  './social-shared-focus-overlay-role-ui.js',
  './social-shared-focus-overlay-solo-room.js',
  ...
  './style.css',
  './supabase-client-row-converters.js',
  './supabase-client.js',
