...
// Supabase Storage'a dosya yükle, signed URL döndür
...
// Dosya eki render bileşeni — mesaj baloncuğu içinde kullanılır
...
// Mesaj input barına dosya yükleme butonu ekle
window.FocusChat.initFileUploadBtn = function(inputBarEl, onFileSelected) {
    ...
    // Butonu textarea'dan önce ekle — textarea, inputBarEl'in DOĞRUDAN çocuğu olmayabilir
    // (ör. .dc-input-row gibi bir sarmalayıcının içinde olabilir); insertBefore yalnızca
    // doğrudan çocuklarla çalıştığından, textarea'nın gerçek ebeveynine ekliyoruz.
...
window.FocusChat.NotifPrefs = {
    ...
    isDndActive() {
        ...
        // Gece yarısını geçen aralıklar (22:00 → 08:00)
...
// ═══════════════════════════════════════════════════════
// FAZ 2: CHAT INPUT BUTON BAĞLAMALARI
// ═══════════════════════════════════════════════════════
