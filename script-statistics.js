...
import { updateGlobalStreak } from './script-misc-widgets.js';
     ...
     // renderStatistics'in Isı Haritası bölümü — saf DOM üretimi, sadece highlightHistory'i
     // dışarıdan alır (getTasksRef/escapeHtml global import/global fonksiyon).
     function renderFocusHeatmap(highlightHistory) {
     ...
     function renderProgressTrendChart(filterDays, highlightHistory) {
     ...
     function _renderProductivityScoreUI(completionRate, habitRate, focusMinutes, completedTaskCount, focusDisplay) {
     ...
     // Faz S devamı, dev fonksiyon refactoru: renderStatistics'ten çıkarıldı.
     function _renderStreakAndAveragesUI(now, highlightHistory, focusMinutes, maxH, setTrend) {
